...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new vn.supa.supa_architecture.SupaArchitecturePlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin supa_architecture, vn.supa.supa_architecture.SupaArchitecturePlugin", e);
    }
    try {
